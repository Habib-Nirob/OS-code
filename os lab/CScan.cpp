...
int main()
{
	...
	int head_location, absolute_head_location;
	cin >> head_location;
	absolute_head_location = head_location;
	...
	for(int i=absolute_head_location; i < NUM_CYLINDERS; i++){
		if(!incomplete_access_cylinders[i] && (i < (NUM_CYLINDERS - 1))){
	...
	for(int i=0; i < absolute_head_location; i++){
